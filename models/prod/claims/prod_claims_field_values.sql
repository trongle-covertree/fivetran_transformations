...
select field_values:documents as documents, to_varchar(field_values:injured_party_info[0]) as injured_party_info,
...
from fivetran_covertree.dynamodb.prod_socotra_claims_table