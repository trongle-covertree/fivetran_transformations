...
select d.deal_id, d.property_policy_number, d.property_community_deal, lower(trim(c.property_communityname)) as property_communityname, c.property_lead_source, c.property_email,
