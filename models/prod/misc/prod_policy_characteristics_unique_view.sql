...
SELECT pk, quote_inception_date, auto_policy_with_agency, date_of_birth, reason_description, reason_code, prior_carrier_name, prioer_policy_expiration_date,
    ...
    trim(agency_contact_name) as agency_contact_name, state, agency_license, street_address, zip_code, animal_bite, conviction, cancellation_renew,
    ...
    policy_updated_timestamp, trim(agent_on_record) as agent_on_record, replaced_timestamp
