...
select
  ...
  display_id,
  convert_timezone('America/New_York', to_timestamp_tz(effective_timestamp/1000)) as effective_timestamp,
  endorsement_locator,
  ...
  number,
  convert_timezone('America/New_York', to_timestamp_tz(policy_end_timestamp/1000)) as policy_end_timestamp,
