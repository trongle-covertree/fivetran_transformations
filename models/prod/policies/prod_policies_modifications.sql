...
select
  ...
  config_version,
  convert_timezone('America/New_York', to_timestamp_ntz(created_timestamp/1000)) as created_timestamp,
  display_id,
  ...
  field_values,
  convert_timezone('America/New_York', to_timestamp_ntz(issued_timestamp/1000)) as issued_timestamp,
  locator,
  media_by_locator,
  name,
