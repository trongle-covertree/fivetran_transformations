...
SELECT 
	...
	b.POLICY_LOCATOR,
	b.EXPOSURE_LOCATOR,
	CASE WHEN b.REPLACED_TIMESTAMP IS NULL THEN 1 ELSE 0 END AS ACTIVE_POLICY_FLAG,
...
FROM
	MYSQL_DATA_MART_10001.EXPOSURE_CHARACTERISTICS_FIELDS a
LEFT JOIN MYSQL_DATA_MART_10001.EXPOSURE_CHARACTERISTICS b
ON a.EXPOSURE_CHARACTERISTICS_LOCATOR =b."LOCATOR" 
GROUP BY
	1,2,3,4