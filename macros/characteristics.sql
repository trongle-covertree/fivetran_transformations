...
(
    ...
    {% if 'agency_id' in char_json['fieldGroupsByLocator'][field_group_key] %}'{{ char_json['fieldGroupsByLocator'][field_group_key]['agency_id'] }}'{% else %}null{% endif %},
    ...
    {% if 'state' in char_json['fieldGroupsByLocator'][field_group_key] %}'{{ char_json['fieldGroupsByLocator'][field_group_key]['state'] }}'{% else %}null{% endif %},
