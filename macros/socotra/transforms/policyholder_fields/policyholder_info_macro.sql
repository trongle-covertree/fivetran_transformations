...
select
	...
	convert_timezone('America/New_York', to_timestamp_tz(ph.created_timestamp/1000)) as created_timestamp,
	convert_timezone('America/New_York', to_timestamp_tz(ph.datamart_created_timestamp/1000)) as datamart_created_timestamp,
	convert_timezone('America/New_York', to_timestamp_tz(ph.datamart_updated_timestamp/1000)) as datamart_updated_timestamp
