...
select
    ...
    to_date(convert_timezone('Etc/GMT', 'America/Los_Angeles', to_timestamp_tz(policy_start_timestamp/1000))) as policy_start_date,
    to_timestamp_tz(policy_end_timestamp/1000) as policy_end_timestamp,
    to_date(convert_timezone('Etc/GMT', 'America/Los_Angeles', to_timestamp_tz(policy_start_timestamp/1000))) as policy_end_date,
    ...
    to_date(convert_timezone('Etc/GMT', 'America/Los_Angeles', to_timestamp_tz(cancellation_timestamp/1000))) as cancellation_date,
