...
select
    ...
    to_date(convert_timezone('Etc/GMT', 'America/Los_Angeles', to_timestamp_tz(contract_start_timestamp/1000))) as contract_start_date,
    to_timestamp_tz(contract_end_timestamp/1000) as contract_end_timestamp,
    to_date(convert_timezone('Etc/GMT', 'America/Los_Angeles', to_timestamp_tz(contract_end_timestamp/1000))) as contract_end_date,
