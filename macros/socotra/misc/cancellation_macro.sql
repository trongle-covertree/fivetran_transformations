...
select
    ...
    to_date(convert_timezone('Etc/GMT', 'America/Los_Angeles', to_timestamp_ntz(sc.effective_timestamp/1000))) as effective_date,
    ...
    to_date(convert_timezone('Etc/GMT', 'America/Los_Angeles', to_timestamp_ntz(sc.issued_timestamp/1000))) as issued_date_pt,
    to_date(convert_timezone('Etc/GMT', 'America/New_York', to_timestamp_ntz(sc.issued_timestamp/1000))) as issued_date_et
