...
(
    ...
    {% if address_char_keys.street_address|length > 0 %}'{{ address_char_keys.street_address }}'{% else %}null{% endif %},
    {% if address_char_keys.lot_unit|length > 0 %}'{{ address_char_keys.lot_unit }}'{% else %}null{% endif %},
    {% if address_char_keys.city|length > 0 %}'{{ address_char_keys.city }}'{% else %}null{% endif %},
